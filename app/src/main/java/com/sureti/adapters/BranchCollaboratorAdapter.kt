...
class BranchCollaboratorAdapter(
    private val list: List<BranchCollaboratorModel>
) :
    RecyclerView.Adapter<BranchCollaboratorAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model: BranchCollaboratorModel = list[position]
